...
export type ZipCreateEntry = { name: string; content: Buffer | string };
...
function normalizeZipName(name: unknown): string {
 ...
 */
export function readZipEntries(buffer: Buffer, options: ZipReadOptions = {}): ZipReadEntry[] {
 ...
 */
export function createZip(entries: ZipCreateEntry[]): Buffer {
