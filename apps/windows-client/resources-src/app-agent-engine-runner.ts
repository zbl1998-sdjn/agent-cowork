...
(function () {
  function createAgentEngineRunner({ state, postJson, setRunChip, setStatus, shortRunId }: any) {
    async function tryAgentEnginePlan(prompt: any, summary: any) {
    ...
    async function tryAgentEngineChat(prompt: any, summary: any) {
      if (!state.modelApiEnabled) {
        setRunChip("模型 API 未配置", "muted");
        return {
          used: false,
