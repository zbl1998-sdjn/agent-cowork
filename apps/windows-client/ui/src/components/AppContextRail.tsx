...
// ---------------------------------------------------------------------------
// 职责:伴随对话常驻右侧,分区显示「运行状态 / 工作文件夹 / 技能·模板」,可收起。
// 仅用 App 已有数据(trustedRoot / recipes / streamingId / mode / model / 轮次),不新增网络请求。
...
export function AppContextRail({ trustedRoot, recipes, streamingId, mode, model, messageCount, onPickRecipe, onToggle }: AppContextRailProps) {
