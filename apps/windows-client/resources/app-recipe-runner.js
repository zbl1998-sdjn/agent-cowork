...
(function () {
    function createRecipeRunner({ state, approveButton, postJson, idempotencyKey, recipeFiles, basename, compactText, subscribeRunEvents, scrollConversationToEnd, appendAssistantMessage, addProgressLines, addPreviewCard, addSourcesFooter, addApprovalActions, setMessageStatus, renderInteraction, renderOperations, setArtifact, setRunChip, refreshRunCards, setStatus, shortRunId, }) {
