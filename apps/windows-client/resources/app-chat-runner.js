...
(function () {
    function createChatRunner({ state, textCandidate, activeFiles, readCandidateSummary, tryKimiChat, refreshRunCards, showChatResponse, appendUserMessage, appendAssistantMessage, appendMessageText, addProgressLines, setMessageStatus, setRunChip, setStatus, shortRunId, }) {
