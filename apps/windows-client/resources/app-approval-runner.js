...
(function () {
    function createApprovalRunner({ state, approveButton, artifactPath, postJson, idempotencyKey, setView, setStatus, setArtifact, renderInteraction, generatePlan, markApprovalDone, addProgressLines, setMessageStatus, addArtifactCard, loadArtifactCatalog, }) {
