...
(function () {
    ...
    function createRunHistoryController({ state, composer, runList, runSummary, getJson, compactText, formatDuration, formatRunTime, renderRunEventPayload, renderInteraction, renderRecipes, setStatus, setArtifact, setRunChip, appendAssistantMessage, scrollConversationToEnd, runStatusText, runTypeText, shortRunId, }) {
