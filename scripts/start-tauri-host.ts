...
const server = createServer(withPublicHostSecurity({
  ...
  modelUserAgent: process.env.ACW_MODEL_USER_AGENT || process.env.KIMI_USER_AGENT,
  modelTemperature: process.env.ACW_MODEL_TEMPERATURE || process.env.KIMI_TEMPERATURE,
