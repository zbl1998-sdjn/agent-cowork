...
const HOST_COVERAGE_PROTECTED_FLOORS = {
  ...
  'src/engine/agent/approval-gate.ts': { linePct: 95, branchPct: 85, functionPct: 95 },
  'src/engine/agent/approval-support.ts': { linePct: 95, branchPct: 95, functionPct: 95 },
  'src/engine/agent/model-call-capability.ts': { linePct: 75, branchPct: 95, functionPct: 95 },
  'src/engine/agent/tool-call-executor.ts': { linePct: 95, branchPct: 85, functionPct: 95 },
