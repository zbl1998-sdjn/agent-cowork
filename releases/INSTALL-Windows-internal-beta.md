# Agent Cowork v0.2.0 Internal Beta 安装教程（Windows）
...
- `Agent-Cowork-Setup-v0.2.0-internal-beta.exe`：Windows 安装程序。
- `Agent-Cowork-Setup-v0.2.0-internal-beta.exe.sha256`：安装程序的 SHA256 指纹。
...
```powershell
Get-FileHash -Algorithm SHA256 .\Agent-Cowork-Setup-v0.2.0-internal-beta.exe
```

3. 确认输出的 `Hash` 等于：

```text
72E79232C769547F8C73DAE2671B2BACA3FF1E98C994D5740C978C3C19E61388
```
...
2. 双击 `Agent-Cowork-Setup-v0.2.0-internal-beta.exe`。
